...
public class MoodleRestUser implements Serializable {
		...
		try {
			...
			for (int i = 0; i < user.length; i++) {
				...
				if (user[i].getUsername() == null)
					...
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][username]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getUsername(), MoodleServices.ENCODING.toString()));
				if (user[i].getPassword() == null)
					throw new MoodleRestUserException(MoodleRestUserException.PASSWORD_NULL);
				else
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][password]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getPassword(), MoodleServices.ENCODING.toString()));
				if (user[i].getFirstname() == null)
					throw new MoodleRestUserException(MoodleRestUserException.FIRSTNAME_NULL);
				else
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][firstname]",
									MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getFirstname(), MoodleServices.ENCODING.toString()));
				if (user[i].getLastname() == null)
					throw new MoodleRestUserException(MoodleRestUserException.LASTNAME_NULL);
				else
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][lastname]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getLastname(), MoodleServices.ENCODING.toString()));
				if (user[i].getEmail() == null)
					throw new MoodleRestUserException(MoodleRestUserException.EMAIL_NULL);
				else
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][email]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getEmail(), MoodleServices.ENCODING.toString()));
				if (user[i].getAuth() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][auth]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getAuth(), MoodleServices.ENCODING.toString()));
				if (user[i].getIdNumber() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][idnumber]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getIdNumber(), MoodleServices.ENCODING.toString()));
				if (user[i].getLang() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][lang]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getLang(), MoodleServices.ENCODING.toString()));
				if (user[i].getTheme() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][theme]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getTheme(), MoodleServices.ENCODING.toString()));
				if (user[i].getTimezone() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][timezone]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getTimezone(), MoodleServices.ENCODING.toString()));
				if (user[i].getMailFormat() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][mailformat]",
									MoodleServices.ENCODING.toString()))
							.append("=").append(URLEncoder.encode("" + (user[i].getMailFormat() ? 1 : 0),
									MoodleServices.ENCODING.toString()));
				if (user[i].getDescription() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][description]",
									MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getDescription(), MoodleServices.ENCODING.toString()));
				if (user[i].getCity() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][city]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getCity(), MoodleServices.ENCODING.toString()));
				if (user[i].getCountry() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][country]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getCountry(), MoodleServices.ENCODING.toString()));
				if (user[i].getAlternatename() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][alternatename]",
									MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode(user[i].getAlternatename(), MoodleServices.ENCODING.toString()));
				if (user[i].getLastnamephonetic() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][lastnamephonetic]",
									MoodleServices.ENCODING.toString()))
							.append("=").append(URLEncoder.encode(user[i].getLastnamephonetic(),
									MoodleServices.ENCODING.toString()));
				if (user[i].getFirstnamephonetic() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][firstnamephonetic]",
									MoodleServices.ENCODING.toString()))
							.append("=").append(URLEncoder.encode(user[i].getFirstnamephonetic(),
									MoodleServices.ENCODING.toString()));
	...
	public static void updateUsers(MoodleUser[] user) throws MoodleRestUserException, MoodleRestException {
		String functionCall = MoodleCallRestWebService.isLegacy() ? MoodleServices.MOODLE_USER_UPDATE_USERS.toString()
				: MoodleServices.CORE_USER_UPDATE_USERS.toString();
		try {
			StringBuilder data = new StringBuilder();
			if (MoodleCallRestWebService.getAuth() == null)
				throw new MoodleRestUserException();
			...
			for (int i = 0; i < user.length; i++) {
				...
				if (user[i].getId() == null)
					...
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][id]", MoodleServices.ENCODING.toString()))
							.append("=")
							.append(URLEncoder.encode("" + user[i].getId(), MoodleServices.ENCODING.toString()));
				if (user[i].getUsername() != null)
					data.append("&")
							.append(URLEncoder.encode("users[" + i + "][username]", MoodleServices.ENCODING.toString()))
							.append("=")
	...
	public static void deleteUsers(Long[] userids)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
		String functionCall = MoodleCallRestWebService.isLegacy() ? MoodleServices.MOODLE_USER_DELETE_USERS.toString()
				: MoodleServices.CORE_USER_DELETE_USERS.toString();
		try {
			StringBuilder data = new StringBuilder();
			if (MoodleCallRestWebService.getAuth() == null)
				throw new MoodleRestUserException();
			...
			for (int i = 0; i < userids.length; i++) {
				if (userids[i] < 1)
					...
					data.append("&").append(URLEncoder.encode("userids[" + i + "]", MoodleServices.ENCODING.toString()))
	 ...
	 * </p>
	 * 
	 * get_user_by_id is deprecated in moodle ws, regen the code to get user by
	 * field
	 * 
	 * @param userid
	...
	public static MoodleUser getUserById(Long userid)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
		MoodleUser[] users = getUsersByField(UserFieldSearch.ID, userid.toString());
		if (users.length == 0)
			return null;

		if (users.length > 1)
			throw new MoodleRestUserException("More them one user with same ID [" + userid + "]");
	...
	public static MoodleUser[] getUsersById(Long[] userids)
		...
		String functionCall = MoodleCallRestWebService.isLegacy()
				? MoodleServices.MOODLE_USER_GET_USERS_BY_ID.toString()
				: MoodleServices.CORE_USER_GET_USERS_BY_ID.toString();
		try {
			StringBuilder data = new StringBuilder();
			if (MoodleCallRestWebService.getAuth() == null)
				throw new MoodleRestUserException();
	...
	public static MoodleUser[] getCourseUserProfiles(UserList[] userList)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException, MoodleUserRoleException {
		Vector v = new Vector();
		MoodleUser user;
		...
		try {
			...
			for (int i = 0; i < userList.length; i++) {
				if (userList[i].getUserId().longValue() < 1l)
					throw new MoodleRestUserException(MoodleRestUserException.INVALID_USERID);
				data.append("&")
						.append(URLEncoder.encode("userlist[" + i + "][userid]", MoodleServices.ENCODING.toString()))
						.append("=").append(userList[i].getUserId());
				data.append("&")
						.append(URLEncoder.encode("userlist[" + i + "][courseid]", MoodleServices.ENCODING.toString()))
	...
	public MoodleUser[] __getCourseUserProfiles(String url, String token, UserList[] userList)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException, MoodleUserRoleException {
		Vector v = new Vector();
		MoodleUser user;
		if (MoodleCallRestWebService.isLegacy())
	...
	public static MoodleUser[] getUsers(Criteria[] criteria)
			throws MoodleRestUserException, MoodleRestException, MoodleUserRoleException {
		Vector v = new Vector();
		MoodleUser user;
		if (MoodleCallRestWebService.isLegacy())
			throw new MoodleRestUserException(MoodleRestException.NO_LEGACY);
	...
	public static MoodleUser[] getUsersByField(UserFieldSearch field, String value)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
	...
	public static MoodleUser[] getUsersByField(UserFieldSearch field, String[] values)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
		if (MoodleCallRestWebService.isLegacy())
	...
	public MoodleUser[] __getUsersByField(String url, String token, UserFieldSearch field, String value)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
		String[] values = new String[1];
		values[0] = value;
	...
	public MoodleUser[] __getUsersByField(String url, String token, UserFieldSearch field, String[] values)
			throws MoodleRestUserException, UnsupportedEncodingException, MoodleRestException {
		if (MoodleCallRestWebService.isLegacy())
			throw new MoodleRestCalendarException(MoodleRestException.NO_LEGACY);
		if (values == null)
	...
	public static void addUserDevice(String appId, String deviceName, String deviceModel, String devicePlatform,
			String deviceVersion, String pushId, String uuId, MoodleWarning[] warnings)
		...
		data.append("&").append(URLEncoder.encode("wsfunction", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode(functionCall, MoodleServices.ENCODING.toString()));
		if (appId == null || deviceName == null || deviceModel == null || devicePlatform == null
				|| deviceVersion == null || pushId == null || uuId == null) {
			throw new MoodleRestException(MoodleRestException.PARAMETER_CANNOT_BE_NULL);
		}
		if (appId.isEmpty() || deviceName.isEmpty() || deviceModel.isEmpty() || devicePlatform.isEmpty()
				|| deviceVersion.isEmpty() || pushId.isEmpty() || uuId.isEmpty()) {
			throw new MoodleRestException(MoodleRestException.REQUIRED_PARAMETER);
		}
		data.append("&").append(URLEncoder.encode("appid", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + appId, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("name", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + deviceName, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("model", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + deviceModel, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("platform", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + devicePlatform, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("version", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + deviceVersion, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("pushid", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + pushId, MoodleServices.ENCODING.toString()));
		data.append("&").append(URLEncoder.encode("uuid", MoodleServices.ENCODING.toString())).append("=")
				.append(URLEncoder.encode("" + uuId, MoodleServices.ENCODING.toString()));
		data.trimToSize();
		NodeList elements = MoodleCallRestWebService.call(data.toString());
	...
	public static MoodleListStatus userViewUserList(Long courseId)
			throws MoodleRestException, UnsupportedEncodingException {
		if (MoodleCallRestWebService.isLegacy())
			throw new MoodleRestException(MoodleRestException.NO_LEGACY);
		StringBuilder data = new StringBuilder();
	...
	public static MoodleListStatus userViewUserProfile(Long userId)
			throws MoodleRestException, UnsupportedEncodingException {
		return userViewUserProfile(userId, null);
	}

	public static MoodleListStatus userViewUserProfile(Long userId, Long courseId)
			throws MoodleRestException, UnsupportedEncodingException {
		if (MoodleCallRestWebService.isLegacy())
			throw new MoodleRestException(MoodleRestException.NO_LEGACY);
		StringBuilder data = new StringBuilder();
		...
		data.append("&").append(URLEncoder.encode("userid", MoodleServices.ENCODING.toString())).append("=")
				.append(userId);
		if (courseId != null)
			data.append("&").append(URLEncoder.encode("courseid", MoodleServices.ENCODING.toString())).append("=")
					.append(courseId);
	...
	public static MoodleRemoveDevice removeUserDevice(Long uuId)
			throws MoodleRestException, UnsupportedEncodingException {
		return removeUserDevice(uuId, null);
	}

	public static MoodleRemoveDevice removeUserDevice(Long uuId, Long appId)
			throws MoodleRestException, UnsupportedEncodingException {
		if (MoodleCallRestWebService.isLegacy())
			throw new MoodleRestException(MoodleRestException.NO_LEGACY);
		StringBuilder data = new StringBuilder();
