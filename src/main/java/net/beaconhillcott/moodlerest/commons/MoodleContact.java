...
public class MoodleContact implements Serializable {
	 ...
	 */
	public MoodleContact(Long idUserContact, String fullname, String profileImageURL, String profileImageURLSmall) {

		this(Long.valueOf(0));
		setContactProfile(idUserContact, fullname, profileImageURL, profileImageURLSmall);
	...
	public MoodleContact(Long idUserContact, String fullname, String profileImageURL, String profileImageURLSmall,
		...
		this(idUserContact, fullname, profileImageURL, profileImageURLSmall, unread);
		setState(state);
	 ...
	 *            profileImageURLSmall of the contact
	 */
	public void setContactProfile(Long idUserContact, String fullname, String profileImageURL,
	...
	public void setMoodleUserContactField(String nodeName, Object content) {
		...
		if ((nodeName.equalsIgnoreCase("id") || nodeName.equalsIgnoreCase("fullname")
				|| nodeName.equalsIgnoreCase("profileimageurl") || nodeName.equalsIgnoreCase("profileimageurlsmall"))
				&& content != null)
