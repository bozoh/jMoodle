...
public class MoodleCourseContentOption implements Serializable {
	...
	/**
	 * Method to set the option name field in the object. Only useful in
	 * construction of data from the webservice.
	 *
	 * @param name
	 *            String
	 */
	...
	/**
	 * Method to set the option value field in the object. Only useful in
	 * construction of data from the webservice.
	 *
	 * @param value
	 *            String
	...
	/**
	 * Method to set the option name and value fields in the object. Only useful
	 * in construction of data from the webservice.
	 * 
	 * @param name
	 *            String
	 * @param value
