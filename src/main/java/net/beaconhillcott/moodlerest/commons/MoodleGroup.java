...
public class MoodleGroup implements Serializable {
	...
	/**
	 * <p>
	 * Method to set a MoodleGroup attribute given the name of the attribute and
	 * its value, both passed as String. Automatic conversion to the internal
	 * type takes place.
	 * </p>
	 * 
	 * @param nodeName
	...
	public void setMoodleGroupField(String nodeName, String content) {
		if (nodeName.equals("id"))
			setId(Long.valueOf(content.trim()));
		if (nodeName.equals("name"))
			setName(content);
		if (nodeName.equals("courseid"))
			setCourseId(Long.valueOf(content.trim()));
		if (nodeName.equals("description"))
			setDescription(content);
		if (nodeName.equals("enrolmentkey"))
			setEnrolmentKey(content);
	}
}
