...
public class MoodleDatabase implements Serializable {
	...
	DescriptionFormat introFormat; // int //intro format (1 = HTML, 0 = MOODLE,
	...
	private Long requiredEntriesToView; // int Optional //requiredentriestoview
										// field
	...
	private String listTemplateHeader; // string Optional //listtemplateheader
										// field
	private String listTemplateFooter; // string Optional //listtemplatefooter
										// field
	...
	public void setField(String name, String value) {
		...
		if (name.equals("coursemodule")) {
			courseModule = Long.parseLong(value);
		...
		if (name.equals("intro")) {
			intro = value;
		} // string //The Database intro
		if (name.equals("introformat")) { // int //intro format (1 = HTML, 0 =
											// MOODLE, 2 = PLAIN or 4 =
											// MARKDOWN)
		...
		if (name.equals("comments")) {
			comments = Long.parseLong(value);
		} // int Optional //comments enabled
		if (name.equals("timeavailablefrom")) {
			timeAvailableFrom = Long.parseLong(value);
		} // int Optional //timeavailablefrom field
		if (name.equals("timeavailableto")) {
			timeAvailableTo = Long.parseLong(value);
		} // int Optional //timeavailableto field
		if (name.equals("timeviewfrom")) {
			timeViewFrom = Long.parseLong(value);
		} // int Optional //timeviewfrom field
		if (name.equals("timeviewto")) {
			timeViewTo = Long.parseLong(value);
		} // int Optional //timeviewto field
		if (name.equals("requiredentries")) {
			requiredEntries = Long.parseLong(value);
		} // int Optional //requiredentries field
		if (name.equals("requiredentriestoview")) {
			requiredEntriesToView = Long.parseLong(value);
		} // int Optional //requiredentriestoview field
		if (name.equals("maxentries")) {
			maxEntries = Long.parseLong(value);
		} // int Optional //maxentries field
		if (name.equals("rssarticles")) {
			rssArticles = Long.parseLong(value);
		} // int Optional //rssarticles field
		if (name.equals("singletemplate")) {
			singleTemplate = value;
		} // string Optional //singletemplate field
		if (name.equals("listtemplate")) {
			listTemplate = value;
		} // string Optional //listtemplate field
		if (name.equals("listtemplateheader")) {
			listTemplateHeader = value;
		} // string Optional //listtemplateheader field
		if (name.equals("listtemplatefooter")) {
			listTemplateFooter = value;
		} // string Optional //listtemplatefooter field
		if (name.equals("addtemplate")) {
			addTemplate = value;
		} // string Optional //addtemplate field
		if (name.equals("rsstemplate")) {
			rssTemplate = value;
		} // string Optional //rsstemplate field
		if (name.equals("rsstitletemplate")) {
			rssTitleTemplate = value;
		} // string Optional //rsstitletemplate field
		if (name.equals("csstemplate")) {
			cssTemplate = value;
		} // string Optional //csstemplate field
		if (name.equals("jstemplate")) {
			jsTemplate = value;
		} // string Optional //jstemplate field
		if (name.equals("asearchtemplate")) {
			aSearchTemplate = value;
		} // string Optional //asearchtemplate field
		if (name.equals("approval")) {
			approval = Integer.parseInt(value);
		} // int Optional //approval field
		if (name.equals("scale")) {
			scale = Long.parseLong(value);
		} // int Optional //scale field
		if (name.equals("assessed")) {
			assessed = Integer.parseInt(value);
		} // int Optional //assessed field
		if (name.equals("assesstimestart")) {
			assessTimeStart = Long.parseLong(value);
		} // int Optional //assesstimestart field
		if (name.equals("assesstimefinish")) {
			assessTimeFinish = Long.parseLong(value);
		} // int Optional //assesstimefinish field
		if (name.equals("defaultsort")) {
			defaultSort = Integer.parseInt(value);
		} // int Optional //defaultsort field
		if (name.equals("defaultsortdir")) {
			defaultSortDir = Integer.parseInt(value);
		} // int Optional //defaultsortdir field
		if (name.equals("editany")) {
			editAny = Integer.parseInt(value);
		} // int Optional //editany field
		if (name.equals("notification")) {
			notification = Integer.parseInt(value);
		} // int Optional //notification field
	}
