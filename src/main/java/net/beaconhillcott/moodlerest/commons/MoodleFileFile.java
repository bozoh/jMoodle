...
public class MoodleFileFile extends MoodleFileParent implements Serializable {
	...
	/**
	 * <p>
	 * Method to set the isdir attribute.
	 * </p>
	 * <p>
	 * Only useful in construction of the object attributes by the call to the
	 * MoodleRestFile.upload webservice.
	 * </p>
	 *
	 * @param isdir
	 *            boolean
	...
	/**
	 * <p>
	 * Method to test the isdir attribute.
	 * </p>
	 *
	 * @return boolean
	 */
	...
	/**
	 * <p>
	 * Method to get the isdir attribute.
	 * </p>
	 *
	 * @return boolean
	 */
	...
	public void setMoodleFileFileField(String field, String value) {
		...
		if (field.equals("isdir") && !value.isEmpty())
			setIsDir(Integer.parseInt(value) != 0);
		if (field.equals("url") && !value.isEmpty())
			setURL(value);
	}
}
