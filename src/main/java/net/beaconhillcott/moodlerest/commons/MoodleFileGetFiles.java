...
/**
 * <p>
 * Class to used to create objects to enable the storage of data returned from
...
public class MoodleFileGetFiles implements Serializable {
	...
	/**
	 * <p>
	 * Constructor which initialises the array storage for the returned results
	 * of a MoodleRestFile.getFiles.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Method to return a pointer to the ArrayList containing the returned
	 * MoodleFileParent objects
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Method to add a MoodleFileParent object to the ArrayList.
	 * </p>
	 * 
	 * @param parent
	 *            MoodleFileParent
	...
	/**
	 * <p>
	 * Method to add a MoodleFileFile object to the ArrayList.
	 * </p>
	 *
	 * @param file
	 *            MoodleFileFile
