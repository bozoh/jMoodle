...
public class MoodleComment implements Serializable {
	...
	public MoodleComment(Long id, String content, Integer format, Long timecreated, String strftimeformat,
			String profileurl, String fullname, String time, String avatar, Long userid, Boolean delete) {
		this.id = id;
	...
	public void setField(String field, String value) {
		if (field != null && !field.isEmpty()) {
			...
			if (field.equals("format"))
				setFormat(Integer.parseInt(value));
			if (field.equals("timecreated"))
				setTimecreated(Long.parseLong(value));
			if (field.equals("strftimeformat"))
				setStrftimeformat(value);
			if (field.equals("profileurl"))
				setProfileurl(value);
			...
			if (field.equals("delete"))
				setDelete((Integer.parseInt(value) != 0));
		}
	}
	...
	public String getFieldAsString(String field) {
		if (field != null && !field.isEmpty()) {
			...
			if (field.equals("content"))
				return getContent();
			if (field.equals("format"))
				return Long.toString(getFormat());
			if (field.equals("timecreated"))
				return Long.toString(getTimecreated());
			if (field.equals("strftimeformat"))
				return getStrftimeformat();
			if (field.equals("profileurl"))
			...
			if (field.equals("delete"))
				return Boolean.toString(getDelete());
		}
		return null;
	}
