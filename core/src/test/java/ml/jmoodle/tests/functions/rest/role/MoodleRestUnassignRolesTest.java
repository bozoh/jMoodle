...
import ml.jmoodle.functions.rest.core.role.MoodleRestUnassignRoles;


/**
 * Manual Role Unassignments Function
 *
 *
...
public class MoodleRestUnassignRolesTest  {
	...
	public void verify_since_version_test() throws MoodleWSFucntionException {
		MoodleRestUnassignRoles cc = (MoodleRestUnassignRoles) MoodleWSFunctionFactory.getFunction(
			MoodleWSFunctions.CORE_ROLE_UNASSIGN_ROLES, mc
		);
	...
	public void verify_function_name_above_or_equal_2_2_0_test () throws MoodleWSFucntionException {
		...
		assertThat(cc.getFunctionName()).isEqualTo("core_role_unassign_roles");
	}
	...
	public void verify_function_name_below_2_2_0_test () throws MoodleWSFucntionException {
		...
		assertThat(cc.getFunctionName()).isEqualTo("moodle_role_unassign");
	}
