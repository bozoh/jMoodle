...
public class Function implements Serializable {
	...
	/**
	 * Method to set a field given its field name and value as Strings, the
	 * value for the "version" field is parsed to a double within the method.
	 * 
	 * @param field
	 *            String
	 * @param value
	...
	public void setFunctionField(String field, String value) {
		if (field.equals("name") && !value.equals(""))
			setName(value);
		if (field.equals("version") && !value.equals(""))
			setVersion(Double.parseDouble(value));
	}
}
