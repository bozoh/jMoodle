...
public class MoodleGradeInstance implements Serializable {
	...
	public void setFieldValue(String name, Object value) {
		if (name != null) {
			if (value != null) {
				if (name.equals("id") || name.equals("raterid") || name.equals("itemid") || name.equals("status")
						|| name.equals("feedbackformat") || name.equals("timemodified")) {
			...
			if (name.equals("rawgrade") || name.equals("feedback")) {
				if (name.equals("rawgrade"))
					setRawGrade((String) value);
	...
	public class Criteria {
		...
		public void setFieldValue(String name, Object value) {
			if (name != null) {
				if (value != null) {
					if (name.equals("id") || name.equals("criteriaid") || name.equals("levelid") || name.equals("score")
							|| name.equals("remarkformat")) {
						if (!((String) value).equals("")) {
							if (name.equals("id")) {
								setId(Long.parseLong((String) value));
							}
