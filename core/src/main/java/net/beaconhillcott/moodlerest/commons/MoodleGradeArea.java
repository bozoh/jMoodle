...
public class MoodleGradeArea implements Serializable {
	...
	public class GradeDefinition implements Serializable {
		...
		public void setFieldValue(String name, Object value) {
			if (value != null) {
				if (name.equals("id") || name.equals("status") || name.equals("descriptionformat")
						|| name.equals("copiedfromid") || name.equals("timecreated") || name.equals("usercreated")
						|| name.equals("timemodified") || name.equals("usermodified") || name.equals("timecopied")) {
					if (!((String) value).equals("")) {
						if (name.equals("id")) {
		...
		public class Guide implements Serializable {
			...
			public class GuideComment {
				...
				public void setFieldValue(String name, String value) {
					if (value != null) {
						if (name.equals("id") || name.equals("sortorder") || name.equals("description")
								|| name.equals("descriptionformat")) {
							if (!(value).equals("")) {
								if (name.equals("id")) {
			...
			public class GuideCriteria implements Serializable {
				...
				public void setFieldValue(String name, String value) {
					if (value != null) {
						if (name.equals("id") || name.equals("sortorder") || name.equals("description")
								|| name.equals("descriptionformat") || name.equals("shortname")
								|| name.equals("descriptionmarkers") || name.equals("descriptionmarkersformat")
								|| name.equals("maxscore")) {
							if (!(value).equals("")) {
								if (name.equals("id")) {
									setId(Long.parseLong(value));
								}
		...
		public class Rubric implements Serializable {
			...
			public class RubricCriteria implements Serializable {
				...
				public class Level {
					...
					public void setFieldValue(String name, String value) {
						if (value != null) {
							if (name.equals("id") || name.equals("score") || name.equals("definition")
									|| name.equals("definitionformat")) {
								if (!(value).equals("")) {
									if (name.equals("id")) {
										setId(Long.parseLong(value));
									}
