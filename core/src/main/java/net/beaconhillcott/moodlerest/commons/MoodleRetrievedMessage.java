...
public class MoodleRetrievedMessage implements Serializable {
	...
	public void setField(String name, String value) {
		...
		if (name.equals("useridfrom")) {
			userIdFrom = Long.parseLong(value);
		}
		if (name.equals("useridto")) {
			userIdTo = Long.parseLong(value);
		}
		...
		if (name.equals("fullmessagehtml")) {
			fullMessageHTML = value;
		}
		if (name.equals("smallmessage")) {
			smallMessage = value;
		}
		if (name.equals("notification")) {
			notification = (!value.equals("0"));
		}
		if (name.equals("contexturl")) {
			contextURL = value;
		}
		if (name.equals("contexturlname")) {
			contextURLName = value;
		}
		if (name.equals("timecreated")) {
			timeCreated = Long.parseLong(value);
		}
		if (name.equals("timeread")) {
			timeRead = Long.parseLong(value);
		}
		if (name.equals("usertofullname")) {
			userToFullname = value;
		}
		if (name.equals("userfromfullname")) {
			userFromFullname = value;
		}
	}
}
