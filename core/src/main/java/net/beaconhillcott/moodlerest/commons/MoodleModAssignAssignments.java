...
public class MoodleModAssignAssignments implements Serializable {
	...
	public class Assignment {
		...
		public void setFieldValue(String name, String value) {
			if (name.equals("id") || name.equals("course") || name.equals("nosubmissions")
					|| name.equals("submissiondrafts") || name.equals("sendnotifications")
					|| name.equals("sendlatenotifications") || name.equals("duedate")
					...
					|| name.equals("blindmarking") || name.equals("revealidentities")
					|| name.equals("requiresubmissionstatement")) {
				if (value != null && !value.isEmpty()) {
					if (name.equals("id")) {
						setId(Long.parseLong(value));
					}
					if (name.equals("course")) {
						setCourse(Long.parseLong(value));
					}
					if (name.equals("nosubmissions")) {
						setNoSubmissions(Integer.parseInt(value));
					}
					if (name.equals("submissiondrafts")) {
						setSubmissionDrafts(Integer.parseInt(value));
					}
					if (name.equals("sendnotifications")) {
						setSendNotifications(Integer.parseInt(value));
					}
					if (name.equals("sendlatenotifications")) {
						setSendLateNotifications(Integer.parseInt(value));
					}
					if (name.equals("duedate")) {
						setDueDate(Long.parseLong(value));
					}
					if (name.equals("allowsubmissionsfromdate")) {
						setAllowSubmissionsFromDate(Long.parseLong(value));
					}
					if (name.equals("grade")) {
						setGrade(Integer.parseInt(value));
					}
					if (name.equals("timemodified")) {
						setTimeModified(Long.parseLong(value));
					}
					if (name.equals("completionsubmit")) {
						setCompletionSubmit(Integer.parseInt(value));
					}
					if (name.equals("cutoffdate")) {
						setCutOffDate(Long.parseLong(value));
					}
					if (name.equals("teamsubmission")) {
						setTeamSubmission(Integer.parseInt(value));
					}
					if (name.equals("requireallteammemberssubmit")) {
						setRequireAllTeamMembersSubmit(Integer.parseInt(value));
					}
					if (name.equals("teamsubmissiongroupingid")) {
						setTeamSubmissionGroupingId(Long.parseLong(value));
					}
					if (name.equals("blindmarking")) {
						setBlindMarking(Integer.parseInt(value));
					}
					if (name.equals("revealidentities")) {
						setRevealIdentities(Integer.parseInt(value));
					}
					if (name.equals("requiresubmissionstatement")) {
						setRequireSubmissionStatement(Integer.parseInt(value));
					}
				}
			}
				...
				if (name.equals("id") || name.equals("assignment")) {
					if (value != null && !value.isEmpty()) {
						...
						if (name.equals("assignment")) {
							setAssignment(Long.parseLong(value));
						}
					}
				}
