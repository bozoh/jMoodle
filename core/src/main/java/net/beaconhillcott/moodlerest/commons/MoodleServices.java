...
public enum MoodleServices implements Serializable {
	...
	CORE_GROUP_GET_COURSE_USER_GROUPS("core_group_get_course_user_groups"), // Added
																			// 2015-05-26
																			// (Untested)
	...
	// USER API
	CORE_USER_CREATE_USERS("core_user_create_users"), // MoodleRestUser Tested
														// 21/01/2014
	...
	CORE_USER_GET_COURSE_USER_PROFILES("core_user_get_course_user_profiles"), // MoodleRestUser
																				// Tested
																				// 03/01/2014
	CORE_USER_DELETE_USERS("core_user_delete_users"), // MoodleRestUser Tested
														// 03/02/2014
	CORE_USER_UPDATE_USERS("core_user_update_users"), // MoodleRestUser Tested
														// 21/01/2014
	CORE_USER_GET_USERS("core_user_get_users"), // MoodleRestUser Tested
												// 03/01/2014 and modified
	CORE_USER_GET_USERS_BY_FIELD("core_user_get_users_by_field"), // MoodleRestUser
																	// Tested
																	// 03/01/2014
	CORE_USER_ADD_USER_DEVICE("core_user_add_user_device"), // Moodle 2.6
															// MoodleRestUser
															// (Untested)
	CORE_USER_REMOVE_USER_DEVICE("core_user_remove_user_device"), // MoodleRestUser
																	// added
																	// 28/05/2015
																	// (Untested)
	CORE_USER_VIEW_USER_LIST("core_user_view_user_list"), // MoodleRestUser
															// Tested 27/05/2015
	CORE_USER_VIEW_USER_PROFILE("core_user_view_user_profile"), // MoodleRestUser
																// Tested
																// 27/05/2015
	...
	CORE_ENROL_GET_USERS_COURSES("core_enrol_get_users_courses"), // MoodleRestEnrol
																	...
																	// by
																	// Moodle)
	CORE_ENROL_GET_COURSE_ENROLMENT_METHODS("core_enrol_get_course_enrolment_methods"), // Moodle
																						// 2.6
																						// MoodleRestEnrol
																						// (Tested
																						// but
	...
	ENROL_MANUAL_ENROL_USERS("enrol_manual_enrol_users"), // MoodleRestUserEnrolment
															// Tested 22/01/2014
	ENROL_SELF_GET_INSTANCE_INFO("enrol_self_get_instance_info"), // Moodle 2.6
																	// MoodleRestEnrol
																	// Tested
																	// 21/01/2014
	ENROL_MANUAL_UNENROL_USERS("enrol_manual_unenrol_users"), // Added
																// 2015-05-26
																// (Untested)

	// ROLE
	CORE_ROLE_ASSIGN_ROLES("core_role_assign_roles"), // MoodleRestEnrol Tested
														// 21/01/2014, returns
														// an invalidparameter
	...
	CORE_COURSE_DELETE_COURSES("core_course_delete_courses"), // MoodleRestCourse
																// Tested
																// 02/02/2014
	CORE_COURSE_DUPLICATE_COURSE("core_course_duplicate_course"), // MoodleRestCourse
																	// (Untested)
	...
	CORE_COURSE_DELETE_CATEGORIES("core_course_delete_categories"), // MoodleRestCourse
																	// Tested
																	// 03/02/2014
	CORE_COURSE_IMPORT_COURSE("core_course_import_course"), // MoodleRestCourse
															// (Untested)
	CORE_COURSE_DELETE_MODULES("core_course_delete_modules"), // MoodleRestCourse
	CORE_COURSE_UPDATE_COURSES("core_course_update_courses"), // MoodleRestCourse
																// Tested
																// 02/02/2014
	CORE_COURSE_VIEW_COURSE("core_course_view_course"), // MoodleRestCourse
														// Tested 27/05/2015
	...
	CORE_MESSAGE_GET_CONTACTS("core_message_get_contacts"), // MoodleRestMessage
															// Tested 03/02/2014
	CORE_MESSAGE_SEARCH_CONTACTS("core_message_search_contacts"), // MoodleRestMessage
																	// (Tested
																	// 03/02/2014
																	// Moodle
																	// bug?
																	// Tracker
																	// MDL-42794)
	CORE_MESSAGE_GET_BLOCKED_USERS("core_message_get_blocked_users"), // MoodleRestMessage
																		// added
																		// 28/05/2015
																		// (Untested)
	CORE_MESSAGE_GET_MESSAGES("core_message_get_messages"), // MoodleRestMessage
															// added 28/05/2015
															// (Untested)
	CORE_MESSAGE_MARK_MESSAGE_READ("core_message_mark_message_read"), // MoodleRestMessage
																		// added
																		// 28/05/2015
																		// (Untested)
	...
	MESSAGE_AIRNOTIFIER_ARE_NOTIFICATION_PREFERENCES_CONFIGURED(
			"message_airnotifier_are_notification_preferences_configured"), // MoodleRestMessageAirNotifier
																			// added
																			// 29/05/2015
																			// (Untested)
	MESSAGE_AIRNOTIFIER_IS_SYSTEM_CONFIGURED("message_airnotifier_is_system_configured"), // MoodleRestMessageAirNotifier
																							// added
																							// 29/05/2015
																							// (Tested)
	...
	CORE_NOTES_UPDATE_NOTES("core_notes_update_notes"), // MoodleRestNotes
														// (Untested)
	CORE_NOTES_GET_COURSE_NOTES("core_notes_get_course_notes"), // MoodleRestNotes
																// Tested
																// 28/05/2015
	CORE_NOTES_VIEW_NOTES("core_notes_view_notes"), // MoodleRestNotes Tested
													// 27/05/2015
	...
	// GET
	CORE_GET_STRING("core_get_string"), // MoodleRestStrings (Bug in Moodle,
										// will give an invalid parameter error
										// if not altered within Moodle 2.6)
	CORE_GET_STRINGS("core_get_strings"), // MoodleRestStrings Tested 22/01/2014
	CORE_GET_COMPONENT_STRINGS("core_get_component_strings"), // MoodleRestStrings
																// (Tested
																// 17/12/2013)

	// ASSIGN
	MOD_ASSIGN_GET_GRADES("mod_assign_get_grades"), // MoodleRestModAssign
													// (Untested)
	...
	MOD_ASSIGN_GET_SUBMISSIONS("mod_assign_get_submissions"), // MoodleRestModAssign
																// (Untested)
	MOD_ASSIGN_GET_USER_FLAGS("mod_assign_get_user_flags"), // Moodle 2.6
															// MoodleRestModAssign
															// (Untested)
	MOD_ASSIGN_GET_USER_MAPPINGS("mod_assign_get_user_mappings"), // Moodle 2.6
																	// MoodleRestModAssign
																	// (Untested)
	MOD_ASSIGN_LOCK_SUBMISSIONS("mod_assign_lock_submissions"), // Moodle 2.6
																// MoodleRestModAssign
																// (Untested)
	MOD_ASSIGN_REVEAL_IDENTITIES("mod_assign_reveal_identities"), // Moodle 2.6
																	// MoodleRestModAssign
																	// (Untested)
	MOD_ASSIGN_REVERT_SUBMISSIONS_TO_DRAFT("mod_assign_revert_submissions_to_draft"), // Moodle
																						// 2.6
																						// MoodleRestModAssign
																						// (Untested)
	MOD_ASSIGN_SAVE_GRADE("mod_assign_save_grade"), // Moodle 2.6
													// MoodleRestModAssign
													// (Untested)
	MOD_ASSIGN_SAVE_SUBMISSION("mod_assign_save_submission"), // Moodle 2.6
																// MoodleRestModAssign
																// (Untested)
	MOD_ASSIGN_SAVE_USER_EXTENSIONS("mod_assign_save_user_extensions"), // Moodle
																		// 2.6
																		// MoodleRestModAssign
																		// (Untested)
	MOD_ASSIGN_SET_USER_FLAGS("mod_assign_set_user_flags"), // Moodle 2.6 Not
															// MoodleRestModAssign
															// (Untested)
	MOD_ASSIGN_SUBMIT_FOR_GRADING("mod_assign_submit_for_grading"), // Moodle
																	// 2.6
																	// MoodleRestModAssign
																	// (Untested)
	MOD_ASSIGN_UNLOCK_SUBMISSIONS("mod_assign_unlock_submissions"), // Moodle
																	// 2.6
																	// MoodleRestModAssign
																	// (Untested)
	MOD_ASSIGN_SAVE_GRADES("mod_assign_save_grades"), // Moodle 2.7 (No code
														// yet)
	...
	CORE_COHORT_UPDATE_COHORTS("core_cohort_update_cohorts"), // MoodleRestCohort
																// (Dodgy Moodle
																// parameter
																// definition
																// for id)
	...
	// GRADES
	CORE_GRADES_GET_GRADES("core_grades_get_grades"), // Moodle 2.7 (No code
														// yet)
	CORE_GRADES_UPDATE_GRADES("core_grades_update_grades"), // Moodle 2.7 (No
															// code yet)
	...
	// FORUM
	MOD_FORUM_GET_FORUMS_BY_COURSES("mod_forum_get_forums_by_courses"), // MoodleRestModForum
																		// Tested
																		// 22/01/2014
	MOD_FORUM_GET_FORUM_DISCUSSIONS("mod_forum_get_forum_discussions"), // MoodleRestModForum
																		// Tested
																		// 22/01/2014
	MOD_FORUM_GET_FORUM_DISCUSSION_POSTS("mod_forum_get_forum_discussion_posts"), // Moodle
																					// 2.7
																					// (No
																					// code
																					// yet)
	MOD_FORUM_GET_FORUM_DISCUSSIONS_PAGINATED("mod_forum_get_forum_discussions_paginated"), // No
																							// code
																							// yet
	MOD_FORUM_VIEW_FORUM("mod_forum_view_forum"), // MoodleRestModForum
													// (Untested)
	MOD_FORUM_VIEW_FORUM_DISCUSSION("mod_forum_view_forum_discussion"), // MoodleRestModForum
																		// (Untested)

	// GRADING
	CORE_GRADING_GET_DEFINITIONS("core_grading_get_definitions"), // Moodle 2.6
																	// MoodleRestGrade
																	// (Untested)
	CORE_GRADING_GET_GRADINGFORM_INSTANCES("core_grading_get_gradingform_instances"), // Moodle
																						// 2.6
																						// MoodleRestGrade
																						// (Untested)
	CORE_GRADING_SAVE_DEFINITIONS("core_grading_save_definitions"), // No code
																	// yet

	// COMMENTS
	CORE_COMMENT_GET_COMMENTS("core_comment_get_comments"), // Added 2015-05-26
															// (Untested)

	// COMPLETION
	CORE_COMPLETION_GET_ACTIVITIES_COMPLETION_STATUS("core_comment_get_activities_completion_status"), // Added
																										// 2015-06-16
																										// (Untested)
	CORE_COMPLETION_GET_COURSE_COMPLETION_STATUS("core_comment_get_course_completion_status"), // No
																								// code
																								// yet
	CORE_COMPLETION_UPDATE_ACTIVITY_COMPLETION_STATUS_MANUALLY(
			"core_comment_update_activity_completion_status_manually"), // No
																		// code
																		// yet
	...
	// GRADEREPORT
	GRADEREPORT_USER_GET_GRADES_TABLE("gradereport_user_get_grades_table"), // No
																			// code
																			// yet
	GRADEREPORT_USER_VIEW_GRADE_REPORT("gradereport_user_view_grade_report"), // No
																				// code
																				// yet

	// DATA
	MOD_DATA_GET_DATABASES_BY_COURSES("mod_data_get_databases_by_courses"), // MoodleRestModData
																			// added
																			// 29/05/2015
																			// (Untested)
	...
	MOODLE_USER_GET_USERS_BY_COURSEID("moodle_user_get_users_by_courseid"), // Not
																			// yet
																			// implemented
	MOODLE_USER_GET_COURSE_PARTICIPANTS_BY_ID("moodle_user_get_course_participants_by_id"), // Not
																							// yet
																							// implemented
	...
	MOODLE_ENROL_GET_USERS_COURSES("moodle_enrol_get_users_courses"), // Not yet
																		// implemented
	MOODLE_ENROL_MANUAL_ENROL_USERS("moodle_enrol_manual_enrol_users"), // Not
																		// yet
																		// implemented
	...
	// MESSAGE
	MOODLE_MESSAGE_SEND_INSTANTMESSAGES("moodle_message_send_instantmessages"), // Not
																				// yet
																				// implemented
