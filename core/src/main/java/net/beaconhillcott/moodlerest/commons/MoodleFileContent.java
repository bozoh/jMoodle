 ...
 * </p>
 * <p>
 * Note no encoding takes place, this is left up to the developer as it may be
 * implementation dependent.
 * </p>
 * <p>
 * Extends MoodleFileFile.
 * </p>
 *
 * @author Bill Antonia
 * @see MoodleFileFile
...
public class MoodleFileContent extends MoodleFileFile implements Serializable {
	...
	/**
	 * <p>
	 * Method to set the file content as a Base64 uuencoded string.
	 * </p>
	 * <p>
	 * Encoding is left to the developer as it may be implementation dependent.
	 * So must be encoded before being stored into the object.
	 * </p>
	 *
	 * @param filecontent
	 *            String
	...
	/**
	 * <p>
	 * Method to get the Base64 uuencoded string held in the object.
	 * </p>
	 *
	...
	public void setMoodleFileContentField(String field, String value) {
		...
		if (field.equals("filecontent") && !value.isEmpty())
			filecontent = value;
	}
}
