		...
		if (("." + VARIABLES + ".").indexOf("." + name + ".") != -1) {
			if (value != null) {
				...
				case LASTUSERPICTURE:
					if (!value.isEmpty()) {
						...
						case TIMEMODIFIED:
							...
							break;
						case USERMODIFIED:
							setUserModified(converted);
							break;
						case TIMESTART:
							setTimeStart(converted);
							break;
						case TIMEEND:
							setTimeEnd(converted);
							break;
						case FIRSTPOST:
							setFirstPost(converted);
							break;
						case FIRSTUSERPICTURE:
							setFirstUserPicture(converted);
							break;
						case LASTPOST:
							setLastPost(converted);
							break;
						case LASTUSERID:
							setLastUserId(converted);
							break;
						case LASTUSERPICTURE:
							setLastUserPicture(converted);
							break;
						}
					}
					break;
				case NAME:
					setName(value);
					break;
				case FIRSTUSERFULLNAME:
					setFirstUserFullname(value);
					break;
				case FIRSTUSERIMAGEALT:
					setFirstUserImageAlt(value);
					break;
				case FIRSTUSEREMAIL:
					setFirstUserEmail(value);
					break;
				case SUBJECT:
					setSubject(value);
					break;
				...
				case NUMUNREAD:
					setNumUnread(value);
					break;
				case LASTUSERFULLNAME:
					setLastUserFullname(value);
					break;
				case LASTUSERIMAGEALT:
					setLastUserImageAlt(value);
					break;
				case LASTUSEREMAIL:
					setLastUserEmail(value);
					break;
				}
			}
		}
